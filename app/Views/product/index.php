		...
		<div class="row">
					...
					<div class="card-body">
						<div class="card-title">
							<div class="list-group">
								<div class="list-item mb-2 active">Pertanian</div>
			...
			<div class="col">
				...
				<div class="col-3 mx-2">
						<div class="card round mt-5 box-product" data-aos="fade-up" style="width: 16rem;">
						<img src="<?= base_url('assets/img/contoh.png') ?>" class="card-img-top " alt="...">
							<div class="card-body">
								<h3 class="card-title card-product-title ">Benih Super Seledri - InFarm</h3>
